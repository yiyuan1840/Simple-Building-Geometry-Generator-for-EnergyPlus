# -*- coding: utf-8 -*-
"""
Created on Wed Jul 04 09:41:14 2018
...
iddfile = "c:/Anaconda2/Lib/site-packages/eppy/resources/iddfiles/Energy+V8_8_0.idd"
IDF.setiddname(iddfile)


def GeoGen():
#    os.chdir(path)
    wb = xw.Book('EPtrace.xlsm') 
...
#st = datetime.datetime.fromtimestamp(ts).strftime('%Y%m%d %H%M%S')
    ...
    new_idf.idfname = "c:/Users/YJIA/Projects/ProjectX/EPC+/EPtrace/NongeoXport "+st+".idf"

    #Import Constructoin Templates
    const_fname="c:/Users/YJIA/Projects/ProjectX/EPC+/EPtrace/ashrae901_construction_templates.idf"
    ...
    version.Version_Identifier = 8.8
